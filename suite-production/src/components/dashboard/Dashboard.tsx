    ...
    return (
      <div className="flex items-center justify-center h-[60vh]">
        <div className="text-center">
          <Bot className="w-12 h-12 text-muted-foreground mx-auto mb-4 animate-bounce" />
          <h2 className="text-xl font-semibold">Loading project data...</h2>
          <p className="text-muted-foreground">Please wait while we sync your dashboard.</p>
        </div>
      </div>
    )
  }
